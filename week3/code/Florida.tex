...
r = 0.5331784
\]
Across 50{,}000 randomly shuffled samples of temperatures and years, none produced a coefficient higher than the observed value. Figure~\ref{fig:hist} shows that the observed correlation lies well outside the tail of the random distribution.

\begin{figure}[h!]
\centering
\includegraphics[width=1\textwidth]{../data/Histogram.pdf}
